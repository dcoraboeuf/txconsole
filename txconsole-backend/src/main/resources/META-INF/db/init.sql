...
CREATE TABLE REQUEST (
  ...
  REQUEST_FILE_TYPE VARCHAR(40) NULL,
  REQUEST_FILE_LENGTH INTEGER NULL,
  REQUEST_FILE_CONTENT LONGBLOB NULL,
  RESPONSE_FILE_TYPE VARCHAR(40) NULL,
  RESPONSE_FILE_LENGTH INTEGER NULL,
  RESPONSE_FILE_CONTENT LONGBLOB NULL,
