...
public interface SQL {
    ...
    String REQUEST_ENTRY_INSERT = "INSERT INTO REQUEST_ENTRY (REQUEST, BUNDLE, SECTION, NAME, TYPE) VALUES (:request, :bundle, :section, :name, :type)";
    String REQUEST_ENTRY_VALUE_INSERT = "INSERT INTO REQUEST_ENTRY_VALUE (REQUEST_ENTRY, LOCALE, OLDVALUE, NEWVALUE) VALUES (:requestEntry, :locale, :oldValue, :newValue)";
    String REQUEST_SET_REQUEST_FILE = "UPDATE REQUEST SET REQUEST_FILE_TYPE = :type, REQUEST_FILE_LENGTH = :length, REQUEST_FILE_CONTENT = :content WHERE ID = :id";
    ...
    String REQUEST_GET_REQUEST_FILE = "SELECT REQUEST_FILE_TYPE, REQUEST_FILE_LENGTH, REQUEST_FILE_CONTENT FROM REQUEST WHERE ID = :id";
}
