                ...
                public Resource<RequestSummary> apply(RequestSummary o) {
                    ...
                    return new Resource<>(o)
                            ...
                            .withLink(linkTo(methodOn(GUIController.class).getRequest(locale, o.getId())).withRel("gui"))
                                    // ACL
                            .withAction(ProjectFunction.REQUEST_UPLOAD, o.getStatus() == RequestStatus.EXPORTED && securityUtils.isGranted(ProjectFunction.REQUEST_UPLOAD, branch.getProjectId()))
                            .withAction(ProjectFunction.REQUEST_MERGE, o.getStatus() == RequestStatus.EXPORTED && securityUtils.isGranted(ProjectFunction.REQUEST_MERGE, branch.getProjectId()))
